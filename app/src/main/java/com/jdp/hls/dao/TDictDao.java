 ...
 * DAO for table "TDICT".
*/
public class TDictDao extends AbstractDao<TDict, Long> {

    public static final String TABLENAME = "TDICT";
    ...
    public TDictDao(DaoConfig config) {
        super(config);
    }
    
    public TDictDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TDICT\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TDICT\"";
        db.execSQL(sql);
    }
