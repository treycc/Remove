...
import com.jdp.hls.page.node.protocol.company.lastst.CompanyMoneyChangeFragment;
...
public interface BaseCompnent {
    void inject(CompensationDetailActivity target);

    void inject(CompanyMoneyChangeFragment target);
