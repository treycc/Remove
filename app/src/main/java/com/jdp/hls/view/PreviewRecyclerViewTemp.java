...
public class PreviewRecyclerViewTemp extends RecyclerView {
    ...
    public PreviewRecyclerViewTemp(Context context) {
        this(context, null);
    }

    public PreviewRecyclerViewTemp(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PreviewRecyclerViewTemp(Context context, @Nullable AttributeSet attrs, int defStyle) {
