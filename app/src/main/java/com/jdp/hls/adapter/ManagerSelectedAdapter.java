 ...
 */
public class ManagerSelectedAdapter extends BaseLvAdapter<Employee> {

    public ManagerSelectedAdapter(Context context, List<Employee> list) {
        super(context, list);
    }
    ...
    public String getIds() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (i != list.size() - 1) {
                sb.append(String.valueOf(list.get(i).getEmployeeId()));
                sb.append("#");
            } else {
                sb.append(String.valueOf(list.get(i).getEmployeeId()));
            }
    ...
    public String getNames() {
        ...
        for (int i = 0; i < list.size(); i++) {
            if (i != list.size() - 1) {
                sb.append(String.valueOf(list.get(i).getRealName()));
                sb.append(",");
            } else {
                sb.append(String.valueOf(list.get(i).getRealName()));
            }
