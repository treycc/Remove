 ...
 */
public class RecoverDialog extends BaseDialog implements RecoverNodeContract.View {

    @Inject
    RecoverNodePresenter recoverNodePresenter;
    ...
    public RecoverDialog(Context context, String buildingId, String buildingType, String statusId) {
    ...
    public void initView() {
        DaggerBaseCompnent.builder()
                ...
                .build()
                .inject(this);
        recoverNodePresenter.attachView(this);
    ...
    public void initNet() {
        ...
        recoverNodePresenter.getRecoverReceiverList(buildingId, buildingType);
    }
    ...
    @Override
    public void onGetReviewRecoverListSuccess(List<ReceivePerson> receivePersonList) {
